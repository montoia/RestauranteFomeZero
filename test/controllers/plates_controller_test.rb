...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post plates_url, params: { plate: { descricao: @plate.descricao, preco: @plate.preco, tempopreparo: @plate.tempopreparo } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { descricao: @plate.descricao, preco: @plate.preco, tempopreparo: @plate.tempopreparo } }
